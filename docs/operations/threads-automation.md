...
- 스케줄러: `.github/workflows/daily-thread.yml` (06:45 / 07:10 / 07:35 KST 3중 예약)
...
1. 깃허브 액션이 06:45 KST에 깨어난다. (밀리면 07:10, 07:35에 한 번 더 시도한다)
...
| 7시에서 몇 분 밀림 | 깃허브 크론은 시각을 보장하지 않는다 (실측 1시간 54분 지연). 3중 예약으로 흡수한다 |
